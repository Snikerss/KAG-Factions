...
void onInit(CBlob@ this)
{
	...
	AddIconToken( "$dynamiteblade_$", "DynamiteBlade.png", Vec2f(16,16), 0);
...
void initForge(CBlob@ this)
{
	...
	switch(itemindex) //Based off of which item index you chose, actually create the shop.
	{
		case SWORDINDEX: //Swords.
		{
			...
			{
				ShopItem@ s = addShopItem(this, "Dynamite Blade", "$dynamiteblade_$", "dynamiteblade", "Explode your enemies or their base with this dangerous toy!", false);
				AddRequirement(s.requirements, "blob", "mat_wood", "Wood", 200);
